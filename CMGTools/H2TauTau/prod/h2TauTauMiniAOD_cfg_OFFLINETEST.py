...
#JSONfile = 'Cert_246908-251883_13TeV_PromptReco_Collisions15_JSON_v2.json'
...
#process.source.lumisToProcess = LumiList.LumiList(filename = 'Cert_246908-251883_13TeV_PromptReco_Collisions15_JSON_v2.json').getVLuminosityBlockRange()
