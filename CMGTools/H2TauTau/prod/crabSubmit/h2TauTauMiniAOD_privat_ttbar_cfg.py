...
dataset_name = '/TT_TuneCUETP8M1_13TeV-powheg-pythia8/RunIISpring15MiniAODv2-74X_mcRun2_asymptotic_v2_ext3-v1/MINIAODSIM'
dataset_files = '.*root'
...
#process.source = cms.Source("PoolSource",
                            #fileNames = cms.untracked.vstring("file:/data/jbrandstetter/CMGTools/testFiles/SUSYGluGlu_offlineTest.root")
...
if runSVFit:
    ...
    process.cmgTauMuCorSVFitPreSel.fitAlgo = "MC"
    process.cmgTauEleCorSVFitPreSel.SVFitVersion = 2
    process.cmgTauEleCorSVFitPreSel.fitAlgo = "MC"
